...
class Settings(Enum):
    ...
    train_2016 = '../input/train_2016_v2.csv'
    train_2017 ='../input/train_2017.csv'
    properties_2016 = '../input/properties_2016.csv'
    properties_2017 = '../input/properties_2017.csv'
...
def _generate_submission():
    ...
    submission.to_csv('sub{}.csv'.format(datetime.now().strftime('%Y%m%d_%H%M%S')), index=False, float_format='%.5f')
